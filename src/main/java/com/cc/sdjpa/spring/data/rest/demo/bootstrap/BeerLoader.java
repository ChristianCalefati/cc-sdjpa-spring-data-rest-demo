package com.cc.sdjpa.spring.data.rest.demo.bootstrap;

import com.cc.sdjpa.spring.data.rest.demo.domain.Beer;
import com.cc.sdjpa.spring.data.rest.demo.domain.BeerStyleEnum;
import com.cc.sdjpa.spring.data.rest.demo.repositories.BeerRepository;
...
public class BeerLoader implements CommandLineRunner {
    ...
    private synchronized void loadBeerObjects() {
        log.warn("Loading initial data. Count is: {}", beerRepository.count());
        ...
        if (beerRepository.count() == 0) {
            ...
            log.warn("Beer Records loaded: {}", beerRepository.count());
        }
    }
}
